...
src/shared/hapi/release.js:
	./node_modules/.bin/pbjs -t static-module -w es6 -o src/shared/hapi/release.js -p $$GOPATH/src/k8s.io/helm/_proto $$GOPATH/src/k8s.io/helm/_proto/hapi/release/release.proto && \
